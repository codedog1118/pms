	...
	<script type="text/javascript">
        ...
        function parseLeader(cid) {
            $.ajax({
                ...
                success:function (msg) {
					$("#cusLeader").prop("value",msg.companyperson);
                }
            });
        }
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		...
		<img onclick="WdatePicker({el:'startTime','skin':'twoer',minDate:'%y-%M-%d'})" src="${pageContext.request.contextPath}/static/js/My97DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle">
	</td>
</tr>
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		...
		<img onclick="WdatePicker({el:'projectTime','skin':'twoer',minDate:'%y-%M-%d'})" src="${pageContext.request.contextPath}/static/js/My97DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle">
	</td>
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input id="planFinishTime" type="text" name="endtime"/>
		<img onclick="WdatePicker({el:'planFinishTime','skin':'twoer',minDate:'%y-%M-%d'})" src="${pageContext.request.contextPath}/static/js/My97DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle">
	</td>
</tr>
...
<td height="28" colspan=4 align=center>
	...
	<a class="coolbg" href="javascript:history.go(-1)">返回</a>
</td>
</tr>
</table>
